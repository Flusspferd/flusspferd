...
ICONV_PUBLIC_API(iconv_t) iconv_open(const char *tocode, const char *fromcode);
ICONV_PUBLIC_API(int) iconv_close(iconv_t cd);
ICONV_PUBLIC_API(size_t) iconv(iconv_t cd, const char **inbuf, size_t *inbytesleft, char **outbuf, size_t *outbytesleft);
